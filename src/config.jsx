...
export function getThemeConfig(env = runtimeEnv) {
  ...
  return {
    primary,
    secondary,
    primaryDark: shadeColor(primary, -12),
    primarySoft: mixColors(primary, "#ffffff", 0.88),
...
export const BRAND_NAME = runtimeEnv.VITE_CLIENT_NAME || runtimeEnv.REACT_APP_CLIENT_NAME || "Jaydeep Traders";
export const BRAND_SINCE = runtimeEnv.VITE_YEAR || runtimeEnv.REACT_APP_YEAR || "";
...
export const STORAGE = {
  customer: "tea.customer",
  adminToken: "tea.admin.token",
  cart: "tea.cart",
};
